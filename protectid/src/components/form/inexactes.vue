...
export default {
  template: `
    <div class="modal fade" id="inexactes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">RECTIFIER DES DONNÉES INEXACTES</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Adresse mail de l'organisme" id="Mailorga9" v-model="email">
                    </div>
                    <div class="form-group" style="display: none">
                        <label for="recipient-name" class="col-form-label">Code postal</label>
                        <input type="text" class="form-control" placeholder="Son code postal"  id="Postalorga9" v-model="addressZip">
                    </div>
                    <div class="form-group" style="display: none">
                        <label for="recipient-name" class="col-form-label">Ville</label>
                        <input type="text" class="form-control" placeholder="Sa ville" id="Villeorga9" v-model="addressCity">
                    </div>
                    <form>
                        <div class="modal-header">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Votre nom" id="Nom9">
                        </div>
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Prénom</label>
                            <input type="text" class="form-control" placeholder="Votre Prénom" id="Prenom9">
                        </div>
                        <div class="form-group">
                            <label for="message-text" class="col-form-label">Adresse mail</label>
                            <input class="form-control" placeholder="Votre adresse mail"  id="Mail9">
                        </div>
                        <div class="form-group" style="display: none">
                            <label for="recipient-name" class="col-form-label">Code postal</label>
                            <input type="text" class="form-control" placeholder="Votre code postal" id="Postal9">
                        </div>
                        <div class="form-group" style="display: none">
                            <label for="recipient-name" class="col-form-label">Ville</label>
                            <input type="text" class="form-control" placeholder="Votre ville" id="Ville9" >
                        </div>
                    </form>
                </div>
...
`,
  ...
  methods: {
    ...
    generatePDF (organismeChanged) {
      ...
      var Nom = document.getElementById('Nom9').value
      var Prenom = document.getElementById('Prenom9').value
      var Mail = document.getElementById('Mail9').value
      var Postal = document.getElementById('Postal9').value
      var Ville = document.getElementById('Ville9').value
      var Mailorga = document.getElementById('Mailorga9').value
      var Postalorga = document.getElementById('Postalorga9').value
      var Villeorga = document.getElementById('Villeorga9').value
      var NP = Nom + ' ' + Prenom
      const doc = new Jspdf()
