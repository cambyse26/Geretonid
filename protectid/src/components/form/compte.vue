                ...
                <div class="modal-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="identifiant" class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="recipient-social_network" class="col-form-label">Nom du réseau social</label>
                            <input type="text" name="social_network" class="form-control" placeholder="Ex : Facebook, Twitter, Linkedin,">
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="heure_fin" class="form-control" placeholder="http://www.">
                        </div>
                        <div class="form-group">
                            <label for="recipient-delete_infos" class="col-form-label">Précisez les informations à supprimer</label>
                            <textarea name="delete_infos" class="form-control" rows="4"></textarea>
                        </div>
                        <div class="modal-header">
...
`,
  ...
  methods: {
    ...
    generatePDF (organismeChanged) {
      ...
      var Mail = document.getElementById('Mail6').value
      var Postal = document.getElementById('Postal6').value
      var Ville = document.getElementById('Ville6').value
      var Mailorga = document.getElementById('Mailorga6').value
      var Postalorga = document.getElementById('Postalorga6').value
      var Villeorga = document.getElementById('Villeorga6').value
      var NP = Nom + ' ' + Prenom
      const doc = new Jspdf()
